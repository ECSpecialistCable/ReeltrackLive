...
if(!user.getJobName().equals("")) {
    welcomeStr = welcomeStr + " of " + user.getJobName() + " Project #" + user.getJobCode();
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div style=\"margin-left:10px;border-bottom:1px solid gray;position:absolute;bottom:0px;padding:5px;padding-left:10px;padding-right:10px;background:black;color:silver;font-size:13px;border-top-left-radius:5px;border-top-right-radius:5px;\">\n");
      out.print( welcomeStr );
      out.write("<a href=\"#\" onclick=\"logout();\" style=\"padding-left:10px;\"><span class=\"glyphicon glyphicon-remove\" style=\"color:red;\"></span></a>\n");
      out.write("</div>\n");
 } 
