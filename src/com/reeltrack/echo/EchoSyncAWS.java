...
public class EchoSyncAWS extends CompManager {
	...
	public static void main(String[] args) {
		EchoSyncAWS EchoSyncAWS = new EchoSyncAWS();
		//String directorToken = args[0];
		try {
			EchoSyncAWS.pushReels();
			//EchoSyncAWS.pullCircuits();
			EchoSyncAWS.closeConnections();
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
