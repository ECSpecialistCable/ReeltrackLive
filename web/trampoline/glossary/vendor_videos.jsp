    ...
    <form:begin submit="true" name="create_reeltrack_video" action="glossary/process.jsp" />
			...
			<form:row_begin />
				...
				<form:buttonset_begin align="left" padding="0"/>
						<form:submit_inline button="save" waiting="true" name="save" action="create_vendor_video" />
				<form:buttonset_end />
			<form:row_end />
    <form:end />
<admin:box_end />
        ...
        <listing:begin />
            ...
            <listing:row_begin row="<%= new Integer(i).toString() %>" />
                ...
                <listing:cell_begin align="right"/>
                    ...
                    <% tempUrl = "glossary/process.jsp?submit_action=delete_vendor_video&" + Glossary.PARAM + "=" + content.getId(); %>
...
<admin:set_tabset url="glossary/_tabset_default.jsp" thispage="vendor_videos.jsp" />
<html:end />
