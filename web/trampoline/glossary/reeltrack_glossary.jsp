...
<html:begin />
<admin:title heading="Glossary" text="ReelTrack"/>
<% if(canEdit) { %>
<admin:subtitle text="Add ReelTrack Glossary" />
<admin:box_begin text="Add ReelTrack Glossary" name="Add"/>
    <form:begin submit="true" name="create_reeltrack_glossary" action="glossary/process.jsp" />
			...
			<form:row_begin />
				...
				<form:buttonset_begin align="left" padding="0"/>
						<form:submit_inline button="save" waiting="true" name="save" action="create_reeltrack_glossary" />
				<form:buttonset_end />
			<form:row_end />
    <form:end />
<admin:box_end />
...
<% if(contents.howMany() > 0) { %>
    <admin:subtitle text="Glossary" />
    <admin:box_begin text="ReelTrack Glossary" name="ReelTrack_Glossary" />
        <listing:begin />
    ...
    <admin:box_end />
<% } else { %>
    <admin:subtitle text="No ReelTrack Glossary Found." />
<% } %>

<admin:set_tabset url="glossary/_tabset_default.jsp" thispage="reeltrack_glossary.jsp" />
<html:end />
