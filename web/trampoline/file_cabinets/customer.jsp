		...
		<form:textfield name="<%= FileCabinet.TITLE_COLUMN %>" label="Title:" />
            ...
            <form:row_begin />
                ...
                <form:buttonset_begin align="left" padding="0"/>
                        <form:submit_inline button="save" waiting="true" name="save" action="create_customer" />
                <form:buttonset_end />
            <form:row_end />
    <form:end />
<admin:box_end />
...
<admin:set_tabset url="file_cabinets/_tabset_default.jsp" thispage="customer.jsp" />
<html:end />