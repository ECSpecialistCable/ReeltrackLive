	 ...
	 <div id="header">
	  ...
	  <div id="footer">
		...
		<table style="width:100%;align:center;" border="1px solid red" cellpadding="3px" cellspacing="0">
			...
			<% for(String key: keys){ %>
				<% ArrayList<Integer> values = contents.get(key); %>
				<tr>
		...
		<%--<div style="border:1px red solid;width:95%;position: absolute;bottom: 10px">
			 <div align="middle" style="border:1px red solid;">
				 Electrical Cable Specialist    6680-C Jones Mill Court Norcross GA 30093
			 </div>
			<div align="left" style="border:1px red solid;">
				 770-446-2222
			 </div>
		 </div>
		 --%>
