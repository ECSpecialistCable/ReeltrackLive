...
<% for(int i=0; i<pickReels.howMany(); i++) { %>
	...
	<table>
	<tr>
		<td class="header" style="font-size:14px;">CRID: ReelTag / Description</td>
	...
	<tr>
		<td class="value" style="font-size:14px;"><b><%= reel.getCrId() %>:</b> <%= reel.getReelTag() %><br /><%= reel.getCableDescription() %></td>
