...
<% dbResources.close(); %>
<html:begin />
<admin:title heading="Issues" text="Resolved" />
...
<% if(contents.howMany() > 0) { %>
    ...
    <admin:box_end />
<% } else { %>
    <admin:subtitle text="There are no Resolved Issues." />
<% } %>

<admin:set_tabset url="issues/_tabset_default.jsp" thispage="resolved.jsp" />
<html:end />
